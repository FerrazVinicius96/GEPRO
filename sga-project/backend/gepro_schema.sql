...
CREATE TABLE IF NOT EXISTS gepro.termo_referencia (
    ...
    modelo_execucao_objeto           TEXT,
    modelo_gestao_contrato           TEXT,
    criterios_medicao_pagamento      TEXT,
    orgaos_participantes             TEXT,
    enderecos_entrega                TEXT,
    requisitos_prova_conceito        TEXT,
    data_criacao                     TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    data_atualizacao                 TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS gepro.cotacao (
    ...
    origem_preco            VARCHAR(50) DEFAULT 'fornecedor'
