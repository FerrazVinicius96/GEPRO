const MODALIDADES_VALIDAS = ['pregao', 'concorrencia', 'concurso', 'leilao', 'dialogo_competitivo', 'dispensa', 'inexigibilidade', 'adesao_arp'];

exports.isArp = (modalidade) => modalidade === 'adesao_arp';
